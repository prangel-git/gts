...
use crate::tree_search_giovanni::alpha_beta_giovanni;
...
pub struct AlphabetaGiovanni<'a, Action, AgentId, T>
where
    AgentId: Eq,
    T: Eq + Hash + Copy,
{
...
impl<'a, Action, AgentId, T> AlphabetaGiovanni<'a, Action, AgentId, T>
where
    AgentId: Eq,
    T: Eq + Hash + Copy,
{
...
impl<'a, Action, AgentId, T> Agent<Action, AgentId, T> for AlphabetaGiovanni<'a, Action, AgentId, T>
where
    AgentId: Eq + Copy,
    Action: Copy,
